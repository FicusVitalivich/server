...
public class JavaApplication1 {
    ...
    public static void main(String[] args) {
        ...
        Studentyi studenty = new Studentyi(gruppyi, "Mi", "Huil", "Abusov", "Vit", "Mos 72", "+375333175285");
        ...
        Query qq = s.createQuery("delete Studentyi where familiya='Mi");
        qq.executeUpdate();
        t3.commit();
        s.flush();
        s.close();
    ...
    public static void findMax(Session s) {
        ...
        List<Studentyi> qs = s.createQuery("from Studentyi e where nomerZachetki =(select max(ee.nomerZachetki) from Studentyi ee)").list();
